...
import { Shield, Database, AlertTriangle, FileCheck, Clock, TrendingUp, TrendingDown, CheckCircle, RefreshCw } from 'lucide-react';

export default function QAIntegrityPage() {
  const pathname = usePathname();
  const [timeRange, setTimeRange] = useState('30days');

  const qaTabs = [
    { id: 'overview', label: 'Overview', icon: Database, path: '/qa-integrity' },
    { id: 'contact-flags', label: 'Contact Flags', icon: AlertTriangle, path: '/qa-integrity/contact-flags' },
    { id: 'audit-log', label: 'Audit Log', icon: Clock, path: '/qa-integrity/audit-log' },
    { id: 'compliance', label: 'Compliance', icon: Shield, path: '/qa-integrity/compliance' },
    { id: 'duplicates', label: 'Duplicates', icon: FileCheck, path: '/qa-integrity/duplicates' }
  ];
