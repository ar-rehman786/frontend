...
import { Home, Building2, Rss, FileText, Upload, CheckSquare, Settings } from 'lucide-react';
        ...
        <>
            <div className="w-64 bg-zinc-900 border-r border-zinc-800 flex flex-col">
                ...
                <div className="p-6 border-b border-zinc-800">
                    <h1 className="text-2xl font-bold text-teal-400">InvestorHub</h1>
                    <p className="text-xs text-gray-400 mt-1">Property Intelligence</p>
                </div>
