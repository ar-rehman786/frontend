                ...
                <div className="flex items-center gap-4 flex-wrap">
                    ...
                    <div className="flex gap-2 flex-wrap">
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${selectedIssue === 'all'
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${selectedIssue === 'missing'
                                    ? 'bg-teal-500 text-white'
                                    : 'bg-zinc-800 text-gray-400 hover:bg-zinc-700'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${selectedIssue === 'invalid'
                                    ? 'bg-teal-500 text-white'
                                    : 'bg-zinc-800 text-gray-400 hover:bg-zinc-700'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${selectedIssue === 'duplicate'
                                    ? 'bg-teal-500 text-white'
                                    : 'bg-zinc-800 text-gray-400 hover:bg-zinc-700'
                                }`}
                        >
