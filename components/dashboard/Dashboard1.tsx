...
// export type DashboardId = 'lender' | 'institutional' | 'sales' | 'marketplace' | 'reports' | 'geo' | 'Lendor' | 'Realtor';
...
// export default function AxisTradeMarket() {
//     const [activeDashboard, setActiveDashboard] = useState<DashboardId>('Lendor');
//     const [activeTab, setActiveTab] = useState<string>('dashboard');
